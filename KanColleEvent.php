<?php
    ...
    switch($_GET['type']) {
        case 'reward': //海域奖励
            GetReward();
            break;
        case 'one_sentence': //一句话攻略
            GetOneSentence((int)$_GET['mission']);
            break;
        case 'blackboard': //黑板翻译
    ...
    function GetHtmlText($url, $start_text, $end_text) {
        ...
        if ($start_pos_temp === false) die("没有找到此内容,可能原作者未更新!");
    ...
    function GetReward() {
        ...
        $start_text = '<h2><span class="mw-headline" id=".E9.80.9A.E5.85.B3.E5.A5.96.E5.8A.B1">通关奖励</span></h2>';
        $end_text = '<h2>';
