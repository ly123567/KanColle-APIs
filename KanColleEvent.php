...
define("EVENT_NAME", "%E6%94%BB%E7%95%A5:2019%E5%B9%B4%E5%86%AC%E5%AD%A3%E6%B4%BB%E5%8A%A8%E6%94%BB%E7%95%A5");
...
function ParseHtmlTable($str) {
	...
	$str = preg_replace("#<tr[^>]*>(.*?)</tr>#is", "", $str);
	$str = preg_replace("#<table[^>]*>(.*?)</table>#is", "", $str);
    return $str;
}

function GetReward() {
    $url = PAGE_DOMAIN . EVENT_NAME;
    $start_text = '通关奖励</span></h';
    $end_text = '<h';
